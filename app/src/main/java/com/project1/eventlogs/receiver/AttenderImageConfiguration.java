package com.project1.eventlogs.receiver;

public class AttenderImageConfiguration {

    public static final String APP_SCRIPT_WEB_APP_URL = "https://script.google.com/macros/s/AKfycbzVomS9FjBKPHXnFgwGiv-Stal9nb-l9u3agfMXpf5WOwB1VfsdLM7Q/exec";
