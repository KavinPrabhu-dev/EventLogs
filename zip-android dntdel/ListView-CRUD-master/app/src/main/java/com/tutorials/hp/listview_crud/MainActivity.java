...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayInputDialog(final int pos)
    {
        ...
        final EditText id1EditTxt= (EditText) d.findViewById(R.id.id1EditText);
        final EditText totalEditTxt= (EditText) d.findViewById(R.id.totalEditText);
        ...
        }else
        {
            ...
            id1EditTxt.setText(crud.getNames().get(pos));
            totalEditTxt.setText(crud.getNames().get(pos));
        }
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String id=id1EditTxt.getText().toString();
                String total=totalEditTxt.getText().toString();
                ...
                if(name.length()>0 && name != null)
                {
                    ...
                    nameEditTxt.setText("");
                    id1EditTxt.setText("");
                    totalEditTxt.setText("");
                    adapter=new ArrayAdapter<String>(MainActivity.this,android.R.layout.simple_list_item_1,crud.getNames());
                    lv.setAdapter(adapter);

                }else
                {
                    Toast.makeText(MainActivity.this, " Id , Name ,Total  cannot be empty", Toast.LENGTH_SHORT).show();
                }
            }
        });
        updateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String newid=id1EditTxt.getText().toString();
                String newtotal=totalEditTxt.getText().toString();
                ...
                if(newName.length()>0 && newName != null)
                {
                    ...
                    if(crud.update(pos,newName))
                    {
                        ...
                        id1EditTxt.setText(newName);
                        totalEditTxt.setText(newName);
                        adapter=new ArrayAdapter<String>(MainActivity.this,android.R.layout.simple_list_item_1,crud.getNames());
                        lv.setAdapter(adapter);
                    }
